  ...
  <div class="site-wrap">
    ...
    <div class="site-section pt-3">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            <h2 class="display-5 mb-3 text-black">Conoce mas de DCON</h2>
          </div>
          <div class="col-lg-6">
            <p>Este proyecto nacio de la necesidad de contar con una herramineta que nos permita gestionar mejor a
              nuestro clientes dandole la opcion de agendar su cita en un horario que pueda.</p>
          </div>
          <div class="col-lg-6">
            <p>DCON es un proyecto nuevo el cual estara en actualizacion constantemente, para brindar el profesionalismo
