...
<head>
  <title>DCONM | Sobre nosotros</title>
    <meta charset="utf-8">
...
<div class="col-3">
  ...
  <img src="img/logo.png" style="width:50%; text-align:center;">
</div>
<div class="col-9">
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-12 text-center">
        ...
        <a href="index.php">Home</a><span class="mx-2">&bullet;</span> Sobre nosotros
      </div>
    </div>
  </div>
</div>
...
<div class="site-section pt-3">
  <div class="container">
    <div class="row mb-5">
      <div class="col-12">
        <h2 class="display-5 mb-3 text-black">Conoce mas de DCONM</h2>
      </div>
      <div class="col-lg-6">
        <p>Este proyecto nacio de la necesidad de contar con una herramineta que nos permita gestionar mejor a
          nuestro clientes dandole la opcion de agendar su cita en un horario que se le facilite.</p>
      </div>
      <div class="col-lg-6">
        <p>DCONM es un proyecto nuevo el cual estara en actualizacion constantemente, para brindar el profesionalismo
          y calidad que merecen nuestros usuario y los clientes de ustedes.</p>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center mb-5">
        <h2 class="display-5 mb-5 text-black">Fundadores</h2>
      </div>
      ...
      <div class="col-md-6 col-lg-4 text-center mb-5">
        <img src="img/yo.png" alt="Image" class="img-fluid w-50 rounded-circle mb-3">
        <h2 class="text-black font-weight-light mb-4">David Flores</h2>
        <p>Programador, sre y pentester de cyber security e investigador en el area de la informatica dispuesto a
          desarrolar herraminetas que faciliten y agilicen la gestión del tiempo</p>
        <p>
          <a href="https://mrdavis-dev.github.io/" class="pl-0 pr-3"><span class="icon-web"></span></a>
          <a href="https://www.instagram.com/mrdavis.dev/" class="pl-3 pr-3"><span
